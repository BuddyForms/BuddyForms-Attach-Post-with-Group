...
<h4>How It Works? </h4>
Create and attach new BuddyPress groups to your posts created with BuddyForms. Whenever a new post is created, a group is also created (you of course get to choose which post types create groups in BuddyForms). The permalink will be rewritten to the group (only for custom post types) and a redirect will publish the posts to the attached group (works for all post types).
...
* BONUS: We introduce a new "Attach Group Type" form element to the Form Builder to attach groups to other groups. Create complex relationships between your groups for every custom post type which is attached to groups.

<h4>Documentation & Support</h4>

Extensive Documentation and Amazing Support. </h4>
